...
{
    public class SystemForAll
    {
        
        //Inner Class WorldSystem containing Database
        class WorldSystem : SystemForAll, IGeographySink110
        { 
        ...
        //Sql Connection method to populate Database
        ...
        public static SqlGeometry GeographyToGeometry(SqlGeography geog, SqlInt32 toSRID)
        {
            ...
            using (SqlConnection conn = new SqlConnection("context connection=true"))
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT Well_Known_Text FROM WorldSystem WHERE Spatial_Reference_Id = @srid", conn);
